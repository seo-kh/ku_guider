...
// import 'package:FlutterMobilenet/widgets/tiny_tiger.dart';
      ...
      body: FutureBuilder<void>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            // If the Fu
            //ture is complete, display the preview.
            return Stack(
              children: <Widget>[
                // TinyTiger(),
                ...
                Recognition(
                  ready: true,
                  // forwardLocaiton: currentLocation,
                ),

                // Align(
                //   // child: Text(currentLocation[0]),
                //   child: Text('Hello'),
                // )
              ],
            );
